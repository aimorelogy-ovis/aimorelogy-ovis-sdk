...
CVI_S32 cvi_sns_getsize(CVI_U32 dev_num, SENSOR_CFG_S *sensor_cfg)
{
	...
	case SMS_SC235HAI_2L_MIPI_2M_60FPS_10BIT:
	...
	case SONY_IMX415_MIPI_2M_30FPS_12BIT:	
	...
	case SMS_SC835_MIPI_2M_30FPS_10BIT:
	case SMS_SC835HAI_MIPI_2M_30FPS_10BIT:
...
CVI_S32 cvi_sns_getsnsobj(CVI_U32 dev_num, SENSOR_CFG_S *sensor_cfg)
{
	...
	case NUC_NC021_MIPI_2M_50FPS_8BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC835)
	case SMS_SC835_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsSC835_Obj;
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC835HAI)
	case SMS_SC835HAI_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsSC835HAI_Obj;
		break;
#endif
	default:
		pSnsObj = CVI_NULL;
