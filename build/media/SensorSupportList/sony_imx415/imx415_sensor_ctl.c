...
static void imx415_linear_2m30_init(VI_PIPE ViPipe);
...
void imx415_init(VI_PIPE ViPipe)
{
	...
	if (enWDRMode == WDR_MODE_2To1_LINE) {
		...
		if(u8ImgMode == IMX415_MODE_2M30)
			imx415_linear_2m30_init(ViPipe);
...
static void imx415_linear_2m30_init(VI_PIPE ViPipe)
{
	//  IMX415-AAQR 2/2-line binning CSI-2_4lane 27MHz AD:10bit Output:12bit 891Mbps Master Mode 30fps Integration Time 33.217ms 
	//  Tool ver : Ver12.0
	...
	imx415_write_register(ViPipe, 0x3024, 0xCA);  // VMAX[19:0]
	imx415_write_register(ViPipe, 0x3025, 0x08);  // VMAX[19:0]
	imx415_write_register(ViPipe, 0x3026, 0x00);  // VMAX[19:0]
	imx415_write_register(ViPipe, 0x3028, 0x4C);  // HMAX[15:0]
	imx415_write_register(ViPipe, 0x3029, 0x04);  // HMAX[15:0]
	...
	imx415_default_reg_init(ViPipe);
	CVI_TRACE_SNS(CVI_DBG_INFO, "ViPipe:%d,===IMX415 1920X1080@30 Init success!===\n", ViPipe);
}