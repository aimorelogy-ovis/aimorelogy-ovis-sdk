    ...
    APP_PARAM_VO_CFG_T* const pstVoCfg)
{
    ...
    switch(*penPanelType) {
        case PANEL_DSI_3AML069LP01G:
            ...
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_3aml069lp01g_600x1024_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_3aml069lp01g_600x1024_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_3aml069lp01g_600x1024_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_3aml069lp01g_600x1024_NULL_4lane_60fps);
            break;

        case PANEL_DSI_GM8775C:
            pstPanelDesc->pchPanelName = "GM8775C";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_gm8775c_1920x1080_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_gm8775c_1920x1080_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_gm8775c_1920x1080_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_gm8775c_1920x1080_NULL_4lane_60fps);
            break;

        case PANEL_DSI_HX8399_1080P:
            pstPanelDesc->pchPanelName = "HX8399_1080x1920";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_hx8399_1080x1920_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_hx8399_1080x1920_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_hx8399_1080x1920_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_hx8399_1080x1920_NULL_4lane_60fps);
            break;

        case PANEL_DSI_ICN9707:
            pstPanelDesc->pchPanelName = "ICN9707-480x1920";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_icn9707_480x1920_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_icn9707_480x1920_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_icn9707_480x1920_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_icn9707_480x1920_NULL_4lane_60fps);
            break;

        case PANEL_DSI_ILI9881C:
            pstPanelDesc->pchPanelName = "ILI9881C-720x1280";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_ili9881c_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_ili9881c_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_ili9881c_720x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_ili9881c_720x1280_NULL_4lane_60fps);
            break;

        case PANEL_DSI_ILI9881D:
            pstPanelDesc->pchPanelName = "ILI9881D-720x1280";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_ili9881d_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_ili9881d_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_ili9881d_720x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_ili9881d_720x1280_NULL_4lane_60fps);
            break;

        case PANEL_DSI_JD9366AB:
            pstPanelDesc->pchPanelName = "JD9366AB-800x1280";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_jd9366ab_800x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_jd9366ab_800x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_jd9366ab_800x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_jd9366ab_800x1280_NULL_4lane_60fps);
            break;
        ...
        case PANEL_DSI_NT35521:
            ...
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_nt35521_800x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_nt35521_800x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_nt35521_800x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_nt35521_800x1280_NULL_4lane_60fps);
            break;

        case PANEL_DSI_OTA7290B:
            pstPanelDesc->pchPanelName = "OTA7290B-320x1280";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_ota7290b_320x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_ota7290b_320x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_ota7290b_320x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_ota7290b_320x1280_NULL_4lane_60fps);
            break;

        case PANEL_DSI_OTA7290B_1920:
            pstPanelDesc->pchPanelName = "OTA7290B-440x1920";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_ota7290b_440x1920_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_ota7290b_440x1920_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_ota7290b_440x1920_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_ota7290b_440x1920_NULL_4lane_60fps);
            break;

        case PANEL_DSI_ST7701:
            pstPanelDesc->pchPanelName = "ST7701-480x800";
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_st7701_480x800_NULL_2lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_st7701_480x800_NULL_2lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_st7701_480x800_NULL_2lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_st7701_480x800_NULL_2lane_60fps);
            break;
        ...
        default:
            ...
            pstPanelDesc->pstDevCfg = &dev_cfg_dsi_hx8394_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstHsTimingCfg = &hs_timing_cfg_dsi_hx8394_720x1280_NULL_4lane_60fps;
            pstPanelDesc->pstDsiInitCmds = dsi_init_cmds_dsi_hx8394_720x1280_NULL_4lane_60fps;
            pstPanelDesc->s32DsiInitCmdsSize = ARRAY_SIZE(dsi_init_cmds_dsi_hx8394_720x1280_NULL_4lane_60fps);
            break;
    }
